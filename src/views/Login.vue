<template>
    <div
        class="login"
        :style="{color: platforms[currentPlatform].bgColor}"
    >
    ...
    export default {
        ...
        methods: {
            setPlatform(event) {
                ...
                this.currentPlatform = [0, this.platforms.length - 1, this.currentPlatform + offset].sort((a, b) => (a - b))[1]
            }
        },
        data() {
            return {
...
<style scoped>
    ...
    .login-form-header {
        ...
        animation: login-header 15s infinite alternate-reverse linear;
    }
    @keyframes login-header {
        0% {
            transform: scaleX(1) scaleY(1)
        }
        25% {
            transform: scaleX(1.9) scaleY(0.8)
        }
        50% {
